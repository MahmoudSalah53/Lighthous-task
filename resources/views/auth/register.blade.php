<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600 mt-1">Join us today</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                            type="password"
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <x-primary-button class="ms-4 bg-indigo-600 hover:bg-indigo-700 rounded-lg px-6 py-2">
                {{ __('Register') }}
            </x-primary-button>
        </div>
    </form>
